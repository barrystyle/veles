...
When veles is configured with the `-deprecatedrpc=accounts` setting, specifying
...
- #14698 `ec71f06` Add veles-tx.exe into Windows installer (ken2812221)
