Veles Core version 0.9.4 is now available from:

  https://veles.org/bin/0.9.4/
...
this update is incompatible with the Veles system and could lead to consensus
forks.

Veles Core released binaries from https://veles.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~veles/+archive/ubuntu/veles
- A third-party or self-compiled Veles Core

upgrade to Veles Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
