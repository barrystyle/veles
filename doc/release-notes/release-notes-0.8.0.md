Veles-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/veles/files/Veles/veles-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Veles
...
New/changed settings (command-line or veles.conf file)
--------------------------------------------------------
