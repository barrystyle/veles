Veles Core version 0.16.1 is now available from:

  <https://velescore.org/bin/veles-core-0.16.1/>
...
- #12843 `df38b13` Test starting velesd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure velesd processes are cleaned up when tests end (sdaftuar)
