Veles Core version 0.14.1 is now available from:

  <https://veles.org/bin/veles-core-0.14.1/>
...
here:
[reducing-velesd-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` veles-tx input verification (awemany, jnewbery)
