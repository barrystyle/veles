Veles Core version 0.16.3 is now available from:

  <https://velescore.org/bin/veles-core-0.16.3/>
...
been discovered in Veles Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` b*bitcoinconsensus: invalid flags error should be set to `b*bitcoinconsensus_err` (afk11)
