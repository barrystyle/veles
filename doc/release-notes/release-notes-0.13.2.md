Veles Core version 0.13.2 is now available from:

  <https://veles.org/bin/veles-core-0.13.2/>
...
- #8908 `4a974b2` Update veles-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow veles-tx to create v2 transactions (btcdrak)
