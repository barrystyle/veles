Veles Core version 0.18.1 is now available from:

  <https://veles.network/download.en.html>

This is a new minor version release, including **important masternode
consensus upgrade**, as well as new features, various bug fixes 
...
### Masternode
- #43    Collateral change from 2000 VLS to 500 VLS
...
### GUI
- #43 	 Coinrequest.io service integration
...
- #15947 Install veles-wallet manpage (domob1812)
