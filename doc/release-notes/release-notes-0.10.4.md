Veles Core version 0.10.4 is now available from:

  <https://veles.org/bin/veles-core-0.10.4/>
...
- #6953 `43c2789` Split veles-tx into its own package
- #6953 `dfe0d4d` Include veles-tx binary on Debian/Ubuntu
