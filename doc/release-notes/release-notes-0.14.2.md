Veles Core version 0.14.2 is now available from:

  <https://veles.org/bin/veles-core-0.14.2/>
...
(in Veles Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate veles-config.h as necessary (theuni)
