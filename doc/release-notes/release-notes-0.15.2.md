Veles Core version *0.15.2* is now available from:

  <https://velescore.org/bin/veles-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in veles-tx (TheBlueMatt)
