...
This document provides guidelines for internationalization of the Veles Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `veles_en.ts` remains unchanged.
