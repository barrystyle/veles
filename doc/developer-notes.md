...
Veles Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
To profile a running velesd process for 60 seconds, you could use an
invocation of `perf record` like this:

```sh
$ perf record \
    -g --call-graph dwarf --per-thread -F 140 \
    -p `pgrep velesd` -- sleep 60
```
...
- src/libsecp256k1
  - Upstream at https://github.com/veles-core/secp256k1/ ; actively maintained by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/veles-core/ctaes ; actively maintained by Core contributors.

- src/univalue
  - Upstream at https://github.com/veles-core/univalue ; actively maintained by Core contributors, deviates from upstream https://github.com/jgarzik/univalue
